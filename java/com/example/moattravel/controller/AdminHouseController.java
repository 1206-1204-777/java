...
public class AdminHouseController {
	...
	public String edit(@PathVariable(name = "id") Integer id, Model model) {
		...
		HouseEditForm houseEditFome = new HouseEditForm(house.getId(), house.getName(),
				null, house.getDescription(), house.getPrice(), house.getCapacity(), house.getAddress(),
				house.getPostalCode(), house.getPhoneNumber());

		model.addAttribute("imageName", imageName);
		model.addAttribute("houseEditForm", houseEditFome);
	...
	public String update(@ModelAttribute @Validated HouseEditForm houseEditForm, BindingResult bindingResult,
		...
		redirectAttributes.addFlashAttribute("successMessage", "登録情報を更新しました。");
